...
This model's performace could potentially be enhanced through the incorporation of external data (e.g. weather) or the addition of other regressors into the algorithm that can either be dervied (e.g. **variance in retail price in the last 30 days**) or be gathered from ATD (e.g. **time of sales, promotion/discount season details, competitor's prices** etc.). If there are any suggestions or you are simply interested in a discussion regarding this project or any other Data Science related concepts, please feel free to contact me through [Linked-In](http://linkedin.com/in/sayankrswar) or shoot an [email](mailto:sayankrswar@hotmail.com). I Thank You for your patience and reading the entire article.
